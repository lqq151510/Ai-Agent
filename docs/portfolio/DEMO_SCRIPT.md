...
5. 如需展示当前源码质量，打开 `EVIDENCE.md` 并说明来源边界：2026-08-27 本地开发基线的 `backend` 为 341 项测试、JaCoCo 行 75.4%/分支 61.8%，Maven `verify` 门禁为行 65%/分支 60%。该记录仍有未提交改动，提交并复跑前不能称为 Beta.2 发布结果。
