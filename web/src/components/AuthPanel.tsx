    ...
    <section className="auth-layout animate-rise">
      ...
      <div className="auth-intro glass-layer">
        <div className="auth-brand">
          <div className="brand-icon">
            <BrandMark size={56} title={null} />
          </div>
          <h1>AI + Java Dev Coach</h1>
        </div>
        <p className="auth-tagline">
          把需求拆解、RAG/Agent
          调试、脚手架生成和日志定位放进一个日常可用的工程工作台。
        </p>
      ...
      >
        <div className="auth-header">
          <p className="badge">
            {authMode === "login" ? "Workspace Access" : "Create Workspace"}
          </p>
          <h2>
            {authMode === "login" ? "进入工程工作台" : "创建你的陪跑空间"}
          </h2>
          <p className="muted">
            {authMode === "login"
              ? "继续你的会话、工具轨迹和开发陪跑记录。"
              : "注册后即可创建 Agent 会话与 Dev Coach 任务。"}
          </p>
        </div>
