...
class SentinelRequestFilterTest {
    ...
    void acceptsCorrectTokenAndRejectsWrongToken() throws Exception {
        SentinelRequestFilter filter = new SentinelRequestFilter("secret", 16384, OWNER, "sentinel");
    ...
    private MockHttpServletRequest request(String authorization, String body) {
        MockHttpServletRequest request = new MockHttpServletRequest("POST", "/api/v1/sentinel/report");
