        ...
        ModelChatRequest request =
                new ModelChatRequest(
                        ...
                        List.of(
                                ModelChatMessage.of(
                                        "system",
                                        "You are an expert Code Reviewer Agent. Review the provided"
                                            + " code for bugs, best practices, and code quality."
        ...
        ModelChatRequest request =
                new ModelChatRequest(
                        ...
                        List.of(
                                ModelChatMessage.of(
                                        "system",
                                        "You are an expert Code Reviewer Agent. Your job is to"
                                            + " review the proposed development plan for"
                                            + " feasibility, scope, and engineering logic. If the"
                                            + " plan is good, feasible, and ready for code"
                                            + " generation, you MUST start your response with"
                                            + " '[APPROVED]'. If you find logic flaws, missing"
                                            + " modules, or design risks, you MUST start your"
                                            + " response with '[REJECTED]' followed by a list of"
