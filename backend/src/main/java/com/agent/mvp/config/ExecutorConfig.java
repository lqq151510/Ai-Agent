...
public class ExecutorConfig {
    ...
    public ThreadPoolTaskExecutor agentStreamExecutor(AppProperties appProperties) {
        ...
        executor.setCorePoolSize(Math.max(1, appProperties.getAgent().getStreamExecutorCorePoolSize()));
        executor.setMaxPoolSize(Math.max(1, appProperties.getAgent().getStreamExecutorMaxPoolSize()));
        executor.setQueueCapacity(Math.max(1, appProperties.getAgent().getStreamExecutorQueueCapacity()));
